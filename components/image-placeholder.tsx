...
export function Ph({
  ...
  if (src) {
    return (
      <div className={`relative overflow-hidden rounded-xl ${minH} ${className}`}>
  ...
  return (
    <div
      className={`relative grid place-items-center overflow-hidden rounded-xl bg-[linear-gradient(160deg,var(--color-panel2),var(--color-panel))] ${minH} ${className}`}
    >
