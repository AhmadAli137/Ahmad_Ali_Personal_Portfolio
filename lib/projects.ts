...
export const projects: Project[] = [
  ...
  },
  {
    ...
    cardBlurb:
      "Dream-flight turned dogfight in Three.js — thread neon gates in Flight, splash five waves of bandits in Sortie. Zero assets, all procedural.",
    ...
    next: "Started as a one-mode dream-flyer; rebuilt in September 2026 with a real flight model, Sortie combat, and eight named sectors.",
    gallery: [
      { caption: "Full afterburner through the valley — 669 km/h, abyssal teal", src: "/img/afterburn-flight.png" },
      { caption: "Sortie, wave 1 — bandit locked, tracers out, one hostile on the scope", src: "/img/afterburn-sortie.png" },
      { caption: "The title screen — the attract reel drifting through sector 01", src: "/img/afterburn-title.png" },
    ],
    links: [
